...
<div class="bg-gray-100">
    <div class="container mx-auto px-4 py-12">
        <h1 class="text-4xl md:text-4xl font-bold text-center text-orange-500 mb-8">Our Story</h1>
        ...
        <div class="bg-white shadow-lg rounded-lg overflow-hidden">
            ...
            <div class="p-6 md:p-10">
                ...
                <p class="text-lg text-black mb-6 leading-relaxed">
                    ...
                    affordable. Whether you're moving into a new place or simply looking to refresh your kitchen,
                ...
                <p class="text-lg text-black mb-6 leading-relaxed">
                    ...
                    make Trisara a brand you can rely on. Thus, by growing alongside our customers, our products have
                ...
                <p class="text-lg text-black mb-6 leading-relaxed">
                    ...
                    thoughtful designs to kitchens across the country.
                </p>

                <p class="text-xl text-black font-semibold mt-12 text-center">
